...
{ /* char stored at left & paddind at buffer's right */
	int k = 0;
	char padd = ' ';
...
/**
 * write_num - Write no. using a bufffer
 * @ind: Index where the no. starts on the buffer
 * @buffer: Buffer
 * @flags: Flags
 * @width: width
 ...
 * @ind: Index where the no. starts in the buffer
